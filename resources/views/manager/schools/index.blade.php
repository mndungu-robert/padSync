...
@section('content')
    ...
    <div class="bg-white border border-gray-200 p-6 rounded-xl shadow-sm space-y-4">
        ...
        <form method="POST" action="{{ route('manager.schools.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
            @csrf
            <div>
            ...
            <table class="w-full text-left border-collapse text-sm">
                <thead>
                    <tr class="bg-gray-50 text-gray-400 text-[11px] font-bold uppercase tracking-wider border-b border-gray-100">
                        ...
                        <th class="px-6 py-3">{{ $currentMonthName }} Girls (Coordinator Submission)</th>
                ...
                <tbody class="divide-y divide-gray-100 text-gray-600">
                    ...
                    <tr class="hover:bg-gray-50/50 transition">
                        ...
                        <td class="px-6 py-4 font-semibold text-slate-700">{{ number_format((int) ($school->current_month_girls ?? 0)) }}</td>
                        <td class="px-6 py-4">
